...
- Clothing Store: any player types :zara in a room to open it. Tabs for Head, Torso, Legs and LTD; click a piece to try it on the mannequin (owned pieces are free to try), then Buy for credits (click Buy twice to confirm). Bought pieces are worn immediately and unlocked in Choose Your Looks. LTD pieces are limited editions: buying one gives a Clothing Token in the Backpack (it takes a slot); using the token unlocks the piece. Prices are set by staff.
